class DashboardProductCreate extends HTMLElement {
  constructor() {
    super();
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-12">
                                  <div class="form-group">
                                    ...
                                    />
                                    <p class="text-muted">Kamu dapat memilih dari satu file</p>
                                  </div>
                                </div>
                              </div>
                              <div class="row">
...
customElements.define('dashboard-productcreate', DashboardProductCreate);
