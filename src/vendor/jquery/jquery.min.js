...
!(function (e, t) {
  ...
  }; function b(e, t, n) { let r; let i; const o = (n = n || E).createElement('script'); if (o.text = e, t) for (r in c)(i = t[r] || t.getAttribute && t.getAttribute(r)) && o.setAttribute(r, i); n.head.appendChild(o).parentNode.removeChild(o); } function w(e) { return e == null ? `${e}` : typeof e === 'object' || typeof e === 'function' ? n[o.call(e)] || 'object' : typeof e; } const f = '3.4.1'; const k = function (e, t) { return new k.fn.init(e, t); }; const p = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g; function d(e) { const t = !!e && 'length' in e && e.length; const n = w(e); return !m(e) && !x(e) && (n === 'array' || t === 0 || typeof t === 'number' && t > 0 && t - 1 in e); }k.fn = k.prototype = {
  ...
  }); const $ = /^(Eval|Internal|Range|Reference|Syntax|Type|URI)Error$/; k.Deferred.exceptionHook = function (e, t) { C.console && C.console.warn && e && $.test(e.name) && C.console.warn(`jQuery.Deferred exception: ${e.message}`, e.stack, t); }, k.readyException = function (e) { C.setTimeout(() => { throw e; }); }; const F = k.Deferred(); function B() { E.removeEventListener('DOMContentLoaded', B), C.removeEventListener('load', B), k.ready(); }k.fn.ready = function (e) { return F.then(e).catch((e) => { k.readyException(e); }), this; }, k.extend({ isReady: !1, readyWait: 1, ready(e) { (!0 === e ? --k.readyWait : k.isReady) || (k.isReady = !0) !== e && --k.readyWait > 0 || F.resolveWith(E, [k]); } }), k.ready.then = F.then, E.readyState === 'complete' || E.readyState !== 'loading' && !E.documentElement.doScroll ? C.setTimeout(k.ready) : (E.addEventListener('DOMContentLoaded', B), C.addEventListener('load', B)); const _ = function (e, t, n, r, i, o, a) { let s = 0; const u = e.length; let l = n == null; if (w(n) === 'object') for (s in i = !0, n)_(e, t, s, n[s], !0, o, a); else if (void 0 !== r && (i = !0, m(r) || (a = !0), l && (a ? (t.call(e, r), t = null) : (l = t, t = function (e, t, n) { return l.call(k(e), n); })), t)) for (;s < u; s++)t(e[s], n, a ? r : r.call(e[s], s, t(e[s], n))); return i ? e : l ? t.call(e) : u ? t(e[0], n) : o; }; const z = /^-ms-/; const U = /-([a-z])/g; function X(e, t) { return t.toUpperCase(); } function V(e) { return e.replace(z, 'ms-').replace(U, X); } const G = function (e) { return e.nodeType === 1 || e.nodeType === 9 || !+e.nodeType; }; function Y() { this.expando = k.expando + Y.uid++; }Y.uid = 1, Y.prototype = {
